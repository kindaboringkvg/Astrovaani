...
export const crystals: Crystal[] = [
  ...
  },
  {
    ...
    color: "Pink",
    chakra: "Heart",
    properties: ["Love", "Compassion", "Peace", "Emotional Stability"],
    description: "The stone of universal love, Rose Quartz promotes inner peace and self-love. It helps to restore trust and harmony in relationships, encouraging unconditional love.",
    uses: ["Emotional Stability", "Relationship Harmony", "Self-Love", "Heart Opening"],
  ...
  },
  {
    ...
    color: "Clear/White",
    chakra: "All Chakras",
    properties: ["Clarity", "Amplification", "Mind Calmness", "Programming"],
    description: "Known as the master healer, Clear Quartz is the most versatile stone among all crystals. It amplifies energy and thought, as well as the effect of other crystals.",
    uses: ["Energy Amplification", "Mind Calmness", "Meditation", "Programming"],
  ...
  color: "Green",
  chakra: "Heart",
  properties: ["Luck", "Prosperity", "Mind Calmness", "Emotional Calmness"],
  ...
  uses: ["Manifestation", "Emotional Calmness", "Prosperity Rituals", "Heart Chakra Balancing"],
  ...
  uses: ["Emotional Calmness", "Intuition Enhancement", "Meditation", "Feminine Energy Work"],
  ...
  color: "Blue/Green",
  chakra: "Throat",
  properties: ["Protection", "Communication", "Mind Calmness", "Wisdom"],
  description: "Firoza, also known as Turquoise, is a protective and soothing stone that has been revered for centuries. It fosters honest and clear communication and is believed to balance and align all chakras, stabilizing mood swings and instilling inner calm.",
  uses: ["Protection", "Communication Enhancement", "Spiritual Connection", "Emotional Calmness"],
  ...
  color: "Multi-Colored",
  chakra: "All Chakras",
  properties: ["Balance", "Mind Calmness", "Alignment", "Energy Flow"],
  ...
  uses: ["Chakra Balancing", "Meditation", "Energy Flow", "Spiritual Alignment"],
